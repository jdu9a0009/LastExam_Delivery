...
func (b *productRepo) Create(c context.Context, req *product_service.CreateProductRequest) (*product_service.Response, error) {
...
func (b *productRepo) Get(c context.Context, req *product_service.IdRequest) (resp *product_service.Product, err error) {
	query := `
		SELECT 
			"id",
			"title", 
...
func (b *productRepo) GetList(c context.Context, req *product_service.ListProductRequest) (*product_service.ListProductResponse, error) {
	var (
...
func (b *productRepo) Update(c context.Context, req *product_service.UpdateProductRequest) (string, error) {
...
func (b *productRepo) Delete(c context.Context, req *product_service.IdRequest) (resp string, err error) {
